...
CONFIG_FIELDS: tuple[ConfigFieldInfo, ...] = (
    ...
    ConfigFieldInfo(ConfigField.POSITION_OFFSET_STEPS, "position_offset_steps", "Reserved in V1; read-only placeholder"),
    ConfigFieldInfo(ConfigField.HOME_POSITION_STEPS, "home_position_steps", "Reserved in V1; read-only placeholder"),
    ...
    ConfigFieldInfo(ConfigField.ENABLE_TIMEOUT_MS, "enable_timeout_ms", "Reserved in V1; explicit mode commands control enable"),
